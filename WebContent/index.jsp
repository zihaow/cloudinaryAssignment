...
<body style="margin: 0;">
    ...
    font-family: sans-serif;text-decoration: none;color:#000;position: relative;
    top: 10px;left: calc(50% - 134.5px);" download>Download</a>
    <a class="backButton" href="image.jsp" style="border: 1px solid #000;border-radius: 3px;padding: 3px 10px;
    font-family: sans-serif;text-decoration: none;color:#000;position: relative;
    top: 10px;left: calc(50% - 126.5px);">View Gallery</a>
